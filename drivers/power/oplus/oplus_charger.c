...
EXPORT_SYMBOL(oplus_chg_set_input_current_limit);
...
EXPORT_SYMBOL(oplus_chg_get_prop_batt_health);
...
EXPORT_SYMBOL(oplus_chg_soc_update_when_resume);
...
EXPORT_SYMBOL(oplus_chg_soc_update);
...
EXPORT_SYMBOL(oplus_tbatt_power_off_task_init);
...
EXPORT_SYMBOL(oplus_get_chg_powersave);
